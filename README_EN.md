# System-Init-Toolbox
【System Init Toolbox · System Initialization Toolbox】A software that allows you to quickly install necessary programs such as runtime libraries after installing the system<br/>
...
This program is developed using [WPF](https://baike.baidu.com/item/WPF/5299594)([.NET](https://dotnet.microsoft.com/zh-cn/) Desktop 6.0), and Use Visual Studio 2022 as editor.
...
Download speed is slow? **[This site](https://d.serctl.com)** might be able to help you.
...
If you have any questions, you can also post them in Issues, and we will try our best to help you solve them when we see them. But before asking questions, please also understand: **[The Wisdom of Asking](https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way/blob/main/README-zh_CN. md)** We reserve the right not to answer or delete your question if we think it is meaningless or duplicated.
